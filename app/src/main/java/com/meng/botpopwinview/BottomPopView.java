...
/**
 * Created by mengcuiguang on 2017/6/26.
 */
...
public class BottomPopView extends LinearLayout {
    ...
    public BottomPopView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BottomPopView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//                        disMissPopupView();
    ...
    public void showPopouView() {
        if (contentView != null) {
            ...
            //把这个区域全部显示出来
            ((BottomPopView) this).setLayoutParams(new RelativeLayout.LayoutParams(
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(
                        RelativeLayout.LayoutParams.MATCH_PARENT, getViewHeight((BottomPopView) BottomPopView.this));
                layoutParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, -1);
                ((BottomPopView) BottomPopView.this).setLayoutParams(layoutParams);
            }
        });
        //开始动画
